...
\mynames{Peter\bibnamedelima Iyer,
  Shankar\bibnamedelimi Sarthak}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Peter Iyer}

  \makefield{\faEnvelope[regular]}{\href{mailto:pir@uga.edu}{\texttt{pir@uga.edu}}}
  \makefield{\faGithub}{\href{https://github.com/ptr-64}{\texttt{ptr-64}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/peter-iyer-a024372b8/}{\texttt{Peter Iyer}}}

  %% Next line
  \makefield{\faGlobe}{\url{https://ptr-64.github.io/}}
